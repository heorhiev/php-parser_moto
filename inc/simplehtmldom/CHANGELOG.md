...
- Added unit tests for memory management of the parser_plugin
...
### Changed
- File and class name changed (html_dom_parser_plugin->simple_html_dom)
### Removed
- ($dom->save_file) will not support anymore
- Remove example "example_customize_parser_plugin.php"
### Fixed
...
- Fixed the bug of customize parser_plugin without $dom->remove_noise()